	...
	public static function profile() {
		...
		$brands = array(
			'cardz3n'      => array(
				...
				'powered_by_label' => __( 'Powered by CARDZ3N', 'cardz3n-gateway' ),
				'website_url'      => 'https://cardz3n.com',
				'support_url'      => 'https://cardz3n.com/support',
				'docs_url'         => 'https://cardz3n.com/docs/woocommerce',
				'primary_color'    => '#0a5cff',
				'accent_color'     => '#00c48c',
				'logo_file'        => 'logo-cardz3n.png',
			),
			'aerospacepay' => array(
				'id'                 => 'aerospacepay',
				...
				'powered_by_label'   => __( 'Powered by AerospacePay', 'cardz3n-gateway' ),
				'website_url'        => 'https://aerospacepay.com',
